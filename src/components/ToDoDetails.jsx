...
export const ToDoDetails = () => {
  ...
  return (
    <div className="flex flex-row justify-between px-6 py-4 text-sm font-bold text-gray-500">
      <p className="font-semibold">{filteredTodos.length} items left</p>
      ...
      <button className="hover:text-white font-semi-bold" onClick={clearCompleted}>Clear Completed</button>
    </div>
  )
}
